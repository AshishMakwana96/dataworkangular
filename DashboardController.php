...
class DashboardController extends Controller {
	...
	public function dashboardData(){
		...
		$toReturn['stats']['students'] = \User::where('role','student')->where('studentAcademicYear',$this->panelInit->selectAcYear)->where('activated',1)->where('account_active',1)->count();
		$toReturn['stats']['teachers'] = \User::where('role','teacher')->where('activated',1)->where('account_active',1)->count();
		$toReturn['stats']['parents'] = \User::where('role','parent')->where('activated',1)->where('account_active',1)->count();
		...
		if($this->data['users']->role == "student"){
			$attendanceArray = \attendance::where('studentId',$this->data['users']->id)->where('date','>=',$startTime)->where('date','<=',$endTime)->orderBy('date','desc')->get();
